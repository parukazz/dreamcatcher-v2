    ...
    <section className="bg-primary text-white h-screen">
      <header className="container py-7 relative z-10">
        <nav className="flex justify-between">
          <div>
            <a href="/" className="font-semibold text-base md:text-lg xl:text-xl leading-4">
              Dreamcatcher
            </a>
          </div>
          <div>
      ...
      <div className="absolute inset-0 container flex flex-col justify-center">
        <div className="2xl:w-[1533px] mx-auto">
          ...
          <div className="flex justify-center gap-10 xl:gap-16 items-center mt-3 xl:mt-0 2xl:-mt-5">
            <div>
              <a href="#" className="flex items-center uppercase text-base md:text-2xl xl:text-4xl font-medium tracking-tight gap-2.5">
                <img src={playIcon} alt="icon play" className="w-10 md:w-16 xl:w-20" />
                justice
              </a>
            </div>
            <div className="flex items-end gap-4">
              <p className="text-accent text-3xl md:text-5xl xl:text-6xl font-bold">VirtuouS</p>
      ...
      <div className="absolute bottom-8 md:bottom-10 container">
        <div className="flex justify-between items-end flex-row-reverse md:flex-row">
          ...
          <div className="md:hidden xl:block">
            <p className="text-accent text-md xl:text-5xl xl:font-bold">&copy;2024</p>
          </div>
